...
export const THEMES = {
  ...
  lilac: {
    ...
    light: {
      ...
      warning: '#ffa74c', flair: '#ffa74c', flairInk: '#33240f', action: '#5f74cc',
    ...
    dark: {
      ...
      warning: '#ffa74c', flair: '#ffa74c', flairInk: '#33240f',
...
function vars(t, mode) {
  ...
  --flair: ${t.flair ?? t.accent}; --flair-ink: ${t.flairInk ?? t.accentInk};${t.warning ? `\n  --warning: ${t.warning};` : ''}
